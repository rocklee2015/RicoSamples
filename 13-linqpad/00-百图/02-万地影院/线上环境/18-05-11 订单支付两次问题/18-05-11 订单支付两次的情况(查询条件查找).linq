...
.Where(a => a.Status > (int)OrderStatus.NoPay && a.Status < (int)OrderStatus.Expired)
.Where(a=>a.CreateTime>DateTime.Parse("2018-03-01") && a.CreateTime<DateTime.Parse("2018-05-30"))
.Where(a => (a.PayType == (int)PayType.LeaguerPay && a.CardTotal != a.ThirdPay) || (a.PayType != (int)PayType.LeaguerPay && a.Total != a.ThirdPay)||a.MerchantOrderId.Equals("20180318XX1185000001445100W610"))
