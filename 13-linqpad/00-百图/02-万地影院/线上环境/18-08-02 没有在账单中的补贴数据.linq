...
.Where(a => (a.Status == (int)OrderStatus.PrintTicket)&&a.PayType!=(int)PayType.LeaguerPay)
.Where(a=>a.CreateTime > DateTime.Parse("2018-07-01 06:00:00"))
.Where(a=>a.CreateTime < DateTime.Parse("2018-07-02 06:00:00"))
