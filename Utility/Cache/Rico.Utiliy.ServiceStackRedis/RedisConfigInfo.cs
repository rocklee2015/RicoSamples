...
namespace Rico.Utiliy.ServiceStackRedis
{
    public sealed class RedisConfigInfo : ConfigurationSection
    {
        ...
        {
            get { return (int) base["LocalCacheTime"]; }
            set { base["LocalCacheTime"] = value; }
        }
        ...
        {
            get { return (bool) base["RecordeLog"]; }
            set { base["RecordeLog"] = value; }
        }
    }
}
